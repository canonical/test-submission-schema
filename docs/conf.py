...
project = "Test Submission Schema"
...
html_context = {
    ...
    "product_page": "certification.ubuntu.com",
    ...
    "github_url": "https://github.com/canonical/test-submission-schema",
...
linkcheck_ignore = [
    ...
    "https://github.com/canonical/test-submission-schema/blob/main/test_submission_schema/v1.json",
]
